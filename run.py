...
def get_sales_data():
    ...
    The while loop will run until a valid input is given.
    """
    while True:
...
def validate_data(values):
    ...
    Rainse ValueError if strings cannot be converted into int, 
...
# """ 
# These update functions has been refactored intom update_worksheet
# """
